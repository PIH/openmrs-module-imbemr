 ...
 */
public class ImbEmrTimerTask extends TimerTask {

    private final Logger log = LoggerFactory.getLogger(getClass());

    private static DaemonToken daemonToken;
    public static void setDaemonToken(DaemonToken daemonToken) {
        ImbEmrTimerTask.daemonToken = daemonToken;
    }

    private static boolean enabled = false;
    public static void setEnabled(boolean enabled) {
        ImbEmrTimerTask.enabled = enabled;
    }
    ...
    public ImbEmrTimerTask(Class<? extends Runnable> taskClass) {
