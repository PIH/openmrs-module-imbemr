...
connection.url=jdbc:mysql://db:3306/openmrs?autoReconnect=true&sessionVariables=storage_engine=InnoDB&useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull
...
wait-for-it -t 0 db:3306 -- $CATALINA_HOME/bin/catalina.sh jpda run