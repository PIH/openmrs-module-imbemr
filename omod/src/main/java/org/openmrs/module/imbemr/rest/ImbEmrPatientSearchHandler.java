...
@Component
public class ImbEmrPatientSearchHandler extends PatientByIdentifierSearchHandler1_8 {

	protected final Log log = LogFactory.getLog(getClass());

	public static final String SEARCH_ID = "imbemrPatientSearch";

	private final PatientService patientService;

	public ImbEmrPatientSearchHandler(@Autowired PatientService patientService) {
