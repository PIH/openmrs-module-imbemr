...
<script type="text/javascript" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    var breadcrumbs = [
        ...
        { label: "${ ui.message("imbemr.admin.configuration") }", link: "${ ui.pageLink("imbemr", "admin/configuration") }" }
    ];
</script>
...
<script type="text/javascript">
    jq(document).ready(function() {
        ...
        jq("#refresh-messageproperties-action").click(function() {
            actionInitiated();
            jq.ajax({type: "PUT", url: openmrsContextPath + '/ws/rest/v1/imbemr/config/messageproperties'})
                .fail(function (data) {
        ...
        jq("#refresh-apps-action").click(function() {
            actionInitiated();
            jq.ajax({type: "PUT", url: openmrsContextPath + '/ws/rest/v1/imbemr/config/appframework'})
                .fail(function (data) {
                    jq("#error-details").html('An error occurred: ' + data.responseText);
                })
                .always(function() {
